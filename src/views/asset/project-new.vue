<template>
	<div class="app-container">
		...
		<div class="table_wrap">
			...
			<div class="con_list">
				<div class="select_wrap">
					...
					<div class="select_con">
						<el-input v-model="projectNameCN" placeholder="请输入项目名称"></el-input>
					</div>
				</div>
            ...
            <p class="devices_btn" @click="changedevices()">点击添加项目设备</p>
					</div>
				</div>
            ...
            <p class="devices_btn" @click="changemembers()">点击添加项目人员</p>
					</div>
				</div>
...
// getUnUserDevice 新建项目-获取设备
// getUserProject 项目成员
// creatProjectInfo 新建项目-提交
import { getUnUserDevice, getUserProject, creatProjectInfo } from '@/api/asset.js'
...
export default {
    ...
    sub_new(){
      ...
      creatProjectInfo(projectInfo).then((res)=>{
        if(res.success){
          layer.msg('提交成功', {
            icon: 1,
            time: 1000 //1秒关闭（如果不配置，默认是3秒）
