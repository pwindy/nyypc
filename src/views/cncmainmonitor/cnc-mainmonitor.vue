              ...
              <div class="r_top">
                  <ul style="margin-bottom:2%;">
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[3].itap | dealNumber }}</span>
                              <span>kW</span>
                          </div>
                      </li>
                      ...
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[7].powerGeneration | dealNumber }}</span>
                              <span>kW</span>
                          </div>
                      </li>
                      <li>
                  ...
                  <ul>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[3].tpap | dealNumber }}</span>
                              <span>MWh</span>
                          </div>
                      </li>
                      <li>
...
export default {
  ...
  methods:{
    ...
    getfirstqx(){
        getListControlDataByID('37').then(data => {
          let szdata = [];

          for (var i in data.result) {
            if (data.result[i].devID === 37) {
          ...
          if(data.length != 0){
            if(this.num > 1){
              if(data[0].time){
                ...
                this.yData_fd.push( data[8].farTAP );
                this.yData_pcs.push( data[8].pcstap );
                this.yData_fz.push( data[8].loadTAP );
