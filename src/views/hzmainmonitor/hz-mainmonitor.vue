                  ...
                  <ul style="margin-bottom:2%;">
                    <li>
                      <div class="liup">
                          ...
                          <span class="uptit">电网功率</span>
                      </div>
                      <div class="lidown">
                          <span>{{ sbdata[4].farTAP | dealNumber }}</span>
                          <span>kW</span>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="lidown">
                          <span>{{ sbdata[0].tap | dealNumber }}</span>
                          <span>kW</span>
                      </div>
                    </li>
                    <li>
                      ...
                      <div class="lidown">
                          <span>{{ sbdata[4].loadTAP | dealNumber }}</span>
                          <span>kW</span>
                      </div>
                    </li>
                  </ul>
                  <ul>
                      <li>
                          <div class="liup">
                              ...
                              <span class="uptit">防逆流值</span>
                          </div>
                          <div class="lidown">
                              <span>{{ sbdata[4].countercurrentControl | dealNumber }}</span>
                              <span></span>
                          </div>
                      </li>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[1].soc | dealNumber }}</span>
                              <span>%</span>
                          </div>
                      </li>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[1].soh | dealNumber }}</span>
                              <span></span>
                          </div>
                      </li>
              ...
              <div class="r_bottom">
                ...
                <ul class="b_ul">
                  <li>
                    ...
                    <img v-if="sbdata[1].comState == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[1].comState == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
...
import liquidFill from '@/assets/echarts-liquidfill.js'
...
export default {
  ...
  methods:{
    ...
    getfirstqx(){
        getListControlDataByID('22').then(data => {
          let szdata = [];

          for (var i in data.result) {
            if (data.result[i].devID === 22) {
        ...
        if(res.success == true){
          ...
          if(this.num > 1){
            if(data[0].time){
              ...
              this.yData_fd.push( data[4].farTAP );
              this.yData_pcs.push( data[4].pcstap );
              this.yData_fz.push( data[4].loadTAP );
