              ...
              <div class="r_top">
                  <ul style="margin-bottom:2%;">
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[12].itap | dealNumber }}</span>
                              <span>kW</span>
                          </div>
                      </li>
                      ...
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[7].powerGeneration | sb_four(sbdata[8].powerGeneration,sbdata[9].powerGeneration,sbdata[10].powerGeneration) }}</span>
                              <span>kW</span>
                          </div>
                      </li>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[0].tap | sb_two(sbdata[1].tap,0) }}</span>
                              <span>kW</span>
                          </div>
                      </li>
                  ...
                  <ul>
                      <li>
                          <div class="liup">
                              <span class="datathree upicon" style="background: #FF0068;"></span>
                              <span class="uptit">总用电量</span>
                          </div>
                          <div class="lidown">
                              <span>{{ sbdata[12].tpap | dwhs }}</span>
                              <span>MWh</span>
                          </div>
                      </li>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[2].soh | sb_two(sbdata[3].soh,1) }}</span>
                              <span></span>
                          </div>
                      </li>
                      <li>
                          ...
                          <div class="lidown">
                              <span>{{ sbdata[2].soc | sb_two(sbdata[3].soc,1) }}</span>
                              <span>%</span>
                          </div>
                      </li>
              ...
              <div class="r_bottom">
                <ul class="b_ul">
                  <li>
                    ...
                    <img v-if="sbdata[0].acDispatch == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].acDispatch == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
                    <span class="spanstate">系统警告</span>
                    <img v-if="sbdata[0].warnState == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].warnState == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                </ul>
                <ul class="b_ul">
                  <li>
                    <span class="spanstate">直流调度</span>
                    <img v-if="sbdata[0].dcDispatch == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].dcDispatch == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
                    <span class="spanstate">系统故障</span>
                    <img v-if="sbdata[0].failureStatus == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].failureStatus == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                </ul>
                <ul class="b_ul">
                  <li>
                    <span class="spanstate">PCS通讯状态</span>
                    <img v-if="sbdata[0].runState == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].runState == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
                    <span class="spanstate">远程控制</span>
                    <img v-if="sbdata[0].remoteControl == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].remoteControl == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                </ul>
                <ul class="b_ul">
                  <li>
                    <span class="spanstate">BMS通讯状态</span>
                    <img v-if="sbdata[2].comState == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[2].comState == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
                ...
                <ul class="b_ul">
                  <li>
                    ...
                    <img v-if="sbdata[0].gridState == 1" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].gridState == 0" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
                ...
                <ul class="b_ul">
                  <li>
                    ...
                    <img v-if="sbdata[0].gridState == 0" src="~@/assets/onoff-on.svg" alt="">
                    <img v-else-if="sbdata[0].gridState == 1" src="~@/assets/onoff-off.svg" alt="">
                  </li>
                  <li>
...
import { getListControlDataByID } from '@/api/projectcurve.js'
...
export default {
  ...
  methods:{
    ...
    getfirstqx(){
        getListControlDataByID('11').then(data => {
          let szdata = [];

          for (var i in data.result) {
            if (data.result[i].devID === 11) {
                szdata.push(data.result[i]);
            }
          }
          ...
          for (let i = 0; i < szdata.length; i++) {
            ...
            this.yData_fd.push(szdata[i].farTAP);
            this.yData_pcs.push(szdata[i].pcstap);
            this.yData_fz.push(szdata[i].loadTAP);
          }
        ...
        if(res.success == true){
          ...
          if(this.num > 1){
            if(data[0].time){
              ...
              let datetime = data[0].time.split('T')[1];
              this.xData.push(datetime);
              this.yData_fd.push( data[11].farTAP );
              this.yData_pcs.push( data[11].pcstap );
              this.yData_fz.push( data[11].loadTAP );
