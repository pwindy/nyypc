<template>
    <div class="lf_bottom_wrap" id="big_wrap" v-if="bigdata && bigdata[0]">
      ...
      <!-- 负载1 -->
      <div v-if="bigdata[0][4].itap == 0" id="gdownline11" class="topdown_big tdstop_big" style="left:37.5%;top:10.8%;height:21%;z-index: 1;background-size: 3px 40px;"></div>
      <div v-else id="gdownline12" class="topdown_big top_big" style="left:37.5%;top:10.8%;height:21%;z-index: 1;background-size: 3px 40px;"></div>

      <!-- 负载2 -->
      <div v-if="bigdata[1][4].itap == 0" id="gdownline12" class="topdown_big tdstop_big" style="left:62.5%;top:10.8%;height:21%;z-index: 1;background-size: 3px 40px;"></div>
      <div v-else id="gdownline12" class="topdown_big top_big" style="left:62.5%;top:10.8%;height:21%;z-index: 1;background-size: 3px 40px;"></div>
      ...
      <div class="sbdiv" style="top:27%;left:80%;" title="点击查看设备详情"  @click="todgdevices">
       ...
       <!-- 负载2 -->
      <div class="sbdiv" style="top:5%;left:35%;" title="负载1">
        <img src="@/assets/bigfz.svg" alt="" />
        <div class="infobox fuzai">
          <div class="sbcanshu">
            <p>P(kW):</p>
            <p>{{ bigdata[0][4].itap }}</p>
          </div>
        </div>
      </div>

      <!-- 负载2 -->
      <div class="sbdiv" style="top:5%;left:60%;" title="负载2">
        <img src="@/assets/bigfz.svg" alt="" />
        <div class="infobox fuzai">
          <div class="sbcanshu">
            <p>P(kW):</p>
            <p>{{ bigdata[1][4].itap }}</p>
          </div>
        </div>
      </div>
