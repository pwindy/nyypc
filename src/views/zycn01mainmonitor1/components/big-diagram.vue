<template>
    <div class="lf_bottom_wrap" id="big_wrap" v-if="bigdata && bigdata[1]">
      ...
      <div v-if="bigdata[2].tap > 0" id="gdownline11" class="topdown_big top_big" style="left:25%; top:15%;  height:60%;z-index: 1;"></div>
      <div v-else-if="bigdata[2].tap < 0" id="gdownline11" class="topdown_big down_big" style="left:48%; top:15%;  height:60%;z-index: 1;"></div>
